...
If you've somehow made it to this site, I can only imagine what you must be doing with your time. I specifically created this package so that you wouldn't have to go digging around for things as you complete the Labs for this semester. Or, at least, not so much.
...
You can install the development version of epiAssist from [GitHub](https://github.com/) with:
